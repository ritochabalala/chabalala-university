    ...
    <div class="navbar navbar-inverse set-radius-zero">
        <div class="container">
            ...
            <div class="navbar-header">
				...
				<a class="navbar-brand" href="home.php"><img src="../assets/img/smu_logo.jpg" width="250" height="50"></a>
            </div>
        </div>
    </div>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="#" class="btn btn-primary btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addPostModal"><i class="fa fa-plus"></i> Apply a Course</a>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<a href="#" class="btn btn-success btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addUsertModal"><i class="fa fa-check"></i> Approved Course</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
