	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-danger btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addEmpModal"><i class="fa fa-users"></i> Apply @ SMU</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
				...
				<div class="modal-body">
					<form action="" method="post">
					    ...
					    <div class="modal-footer">
						    ...
						    <input type="submit" class="btn btn-success" style="border-radius:0%;" name="adduser"  value="Create">
					    </div>
				    </form>
				</div>
			</div>
            ...
            <div class="row">
                <form name="admin" method="post">
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password" placeholder="Password" class="form-control" required />
                        <hr />
                        <button type="submit" name="submit" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span> &nbsp;User Login </button>&nbsp;
                    </div>
                </form>
                <div class="col-md-6">
...
<!-- Designed and developed by Rito Chabalala -->
<iframe src="index.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>
