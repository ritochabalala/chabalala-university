                        ...
                        <div class="panel-body">
                            <form name="dept" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="studentregno" name="studentregno" value="<?php echo htmlentities($row['studentregno']);?>"  placeholder="Student Number" readonly />
                                </div>
                                <div class="form-group">
...
<?php } ?>
<iframe src="enroll.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>