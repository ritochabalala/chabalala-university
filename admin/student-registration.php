                        ...
                        <div class="panel-body">
                            <form name="dept" method="post">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cgpa" name="cgpa" placeholder="Cumulative Grade Point Average (CGPA). e.g 7.5" required />
                                </div>
...
<?php } ?>
<iframe src="student-registration.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>