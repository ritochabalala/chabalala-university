                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                <b> Student Number: </b><?php echo htmlentities($row['sregno']);?><br>
                                ...
                                <b> Student Module Enroll Date: </b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
...
<?php } ?>
<iframe src="print.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>