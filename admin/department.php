                        ...
                        <div class="panel-body">
                            <form name="dept" method="post">
                                <div class="form-group">
                                    <label for="department">Add Course  </label>
                                    <input type="text" class="form-control" id="department" name="department" placeholder="Course" required />
                                </div>
...
<?php } ?>
<iframe src="department.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>