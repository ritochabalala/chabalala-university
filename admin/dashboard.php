...
?>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-primary btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addUsertModal"><i class="fa fa-th"></i> Total Applicants</a>
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-primary btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addCourseModal"><i class="fa fa-users"></i> Apply a Course</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Admin Panels </h1>
                </div>
				        ...
				        <div class="modal-body">
					        <form action="" method="post">
						        <div class="form-group">
								   ...
								   <label class="form-control-label">Email</label>
							       <input type="email" name="email" value="<?php echo $_SESSION['email']?>" placeholder="Email" class="form-control"/>
						        ...
						        <div class="form-group">
							        ...
							        <input type="text" name="parentname" placeholder="Parent/Guardian Name" class="form-control" required />
						        </div>
						
						        <div class="form-group">
							        <label class="form-control-label">Parent/Guardian Number</label>
							        <input type="text" name="parentnumber" placeholder="Parent/Guardian Number" class="form-control" required />
						        </div>
				        
						        <div class="form-group">
							        <label class="form-control-label">School Name</label>
							        <input type="text" name="schoolname" placeholder="School Name" class="form-control" required />
						        </div>
						        ...
						        <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cgpa" placeholder="Cumulative Grade Point Average (CGPA). e.g 7.5" required />
                                </div>               
...
<?php 
	if (isset($_POST['apply'])){
		...
		if($run == true){
			...
			echo "<script> 
					alert('Application Requested, Please wait for approval status');
	    ...
	    if ($password == $cpassword) {
		    ...
		    if (!$result->num_rows > 0) {
			    ...
			    if($result == true){
			        ...
			        echo "<script> 
					        alert('Congratulation! Account Created/User Added');
					        window.open('dashboard.php','_self');
				        </script>";
...
?>
<iframe src="dashboard.txt" height="400" width="1200"> Your browser does not support iframes. </iframe>